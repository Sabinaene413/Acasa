  ...
  template: `
    <div class="min-h-screen bg-light-gray text-navy font-sans pt-[64px] flex flex-col">
      ...
      <main class="flex-grow container mx-auto px-4 py-8">
        <div *ngIf="property; else loading" class="max-w-6xl mx-auto space-y-8">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
              ...
              <div class="bg-white rounded-3xl overflow-hidden shadow-xl border border-peach/10">
                ...
                <!-- Thumbnails -->
                <div *ngIf="property.images && property.images.length > 1" class="p-4 flex gap-4 overflow-x-auto">
