      ...
      <main class="flex-grow flex flex-col items-center py-12 px-4">
        <div class="max-w-4xl w-full space-y-8">
          ...
          <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-peach/20 p-8 md:p-12">
            ...
            <div *ngIf="myProperties.length === 0" class="text-center py-12 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6" *ngIf="myProperties.length > 0">
              <div *ngFor="let property of myProperties" 
                   [routerLink]="['/property', property.id]"
                   class="group bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 hover:border-orange/30 hover:shadow-lg transition-all cursor-pointer">
                <div class="aspect-video relative overflow-hidden">
                  <img *ngIf="property.images && property.images.length > 0" [src]="property.images[0].url" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
